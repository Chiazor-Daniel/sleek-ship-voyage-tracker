...
const ProductTracking = () => {
  ...
  const [selectedProduct, setSelectedProduct] = useState(products[0] || dummyProducts[0]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Process the data to convert coordinates from string to object
        const processedData = data.map(product => {
          if (typeof product.coordinates === 'string') {
            product.coordinates = JSON.parse(product.coordinates);
          }
          return product;
        });
              ...
              <Card className="mb-6">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="h-64">
                      <MapView selectedProduct={selectedProduct} />
                    </div>
                  </div>
                </CardContent>
                <CardFooter>
